...
2. Create or identify the intended branch for that issue from `main`.
3. Create a dedicated worktree for the implementation chat from `main`.
...
- each new implementation branch starts from `main`
